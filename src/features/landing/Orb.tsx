...
export default function Orb({
  ...
  useEffect(() => {
    ...
    const activeTarget = container.closest("section") || container;

    activeTarget.addEventListener("mousemove", handleMouseMove as any);
    ...
    return () => {
      ...
      activeTarget.removeEventListener("mousemove", handleMouseMove as any);
